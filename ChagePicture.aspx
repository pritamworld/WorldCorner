<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChagePicture.aspx.cs" Inherits="css_ChagePicture" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="newmain">
            <div class="newpost">
                ...
                <div class="picchange">
                    <asp:Button ID="UploadButton" runat="server" Text="Upload" CssClass="button autowidth" OnClick="UploadButton_Click" />
                </div>
                <div class="picchange">
                    <asp:Image ID="UploadedImage" runat="server" Visible="false" Height="200" Width="200" />
                </div>
                <div class="picchange">
                    <asp:Button CssClass="button autowidth" ID="ConfirmButton" runat="server" Text="Confirm" OnClick="ConfirmButton_Click" Visible="false" />
                    <asp:Button CssClass="button autowidth" ID="ResetButton" runat="server" Text="Cancel" OnClick="ResetButton_Click" Visible="false" />
                </div>
            </div>
        </div>
    </form>
