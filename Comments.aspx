...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <asp:LinkButton CssClass="linkbutton" ID="LinkButton7" Font-Bold="true" runat="server" PostBackUrl="~/Profiles.aspx"></asp:LinkButton><hr />
        ...
        <div class="navbar">
            <asp:LinkButton CssClass="linkbutton" ID="MyProfileLinkButton" Font-Bold="true" runat="server" PostBackUrl="~/Profiles.aspx"></asp:LinkButton><hr />
                        ...
                        <div class="comments">
                                    ...
                                    <table class="post">
                                        <tr runat="server" class="userdetails tabheader">
                                            <td colspan="2" style="width: 70%;">
                                                <asp:Image ID="CProImage" runat="server" Width="30px" Height="30px" />
                            ...
                            <div class="newcomment">
                                <asp:Panel ID="PostPanel" runat="server">
                                    <asp:TextBox ID="NewPost" runat="server" TextMode="MultiLine" CssClass="inputfield" placeholder="New Comment"></asp:TextBox>
