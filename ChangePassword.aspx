            ...
            <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    ...
                    <div class="passchange">
                        <span class="labletext">Old Password</span>
                        <asp:TextBox CssClass="inputfield" ID="OldPassword" placeholder="Old Password" runat="server" TextMode="Password"></asp:TextBox>
