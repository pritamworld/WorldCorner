...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <asp:LinkButton CssClass="linkbutton" ID="LinkButton14" PostBackUrl="#" Text="Search" runat="server"></asp:LinkButton><hr />
        ...
        <div class="navbar">
            ...
            <asp:LinkButton CssClass="linkbutton" ID="LinkButton15" PostBackUrl="#" Text="Search" runat="server"></asp:LinkButton><hr />
        ...
        <div class="newmain">
            <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <div class="searchbox">
                        <asp:TextBox ID="TextBox1" CssClass="inputfield" runat="server" placeholder="Enter Name or Email"></asp:TextBox>
                        <asp:Button ID="Button1" runat="server" CssClass="button" OnClick="Button1_Click" Text="Search" />
                    </div>
                        ...
                        <asp:ListView ID="ListView1" runat="server" OnItemDataBound="ListView1_ItemDataBound">
                            <ItemTemplate>
                                <table class="post" runat="server">
                                    <tr>
                                        <td rowspan="2" class="imagetd" width="65px">
                                            <asp:Image ID="UserImage" Width="60" Height="60" runat="server" />
                                        </td>
                                        <td class="nametd tabheader">
                                            <a class="link" href="Profiles.aspx?email=<%#Eval("Email") %>"><%#Eval("Name") %> </a>
                                        </td>
