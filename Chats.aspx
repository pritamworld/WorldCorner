<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chats.aspx.cs" Inherits="Chats" %>
...
<head runat="server">
    ...
    <script>
        $(document).ready(function () {
            $("#Panel2").scrollTop($("#Panel2")[0].scrollHeight);
        });
    </script>
    <title>Chats</title>
</head>
    ...
    <form id="form1" runat="server">
                    ...
                    <asp:Panel ID="MsgPanel" CssClass="notmsgpanel" Visible="false" runat="server">
                        ...
                        <div class="notdata">
                            <asp:ListView ID="MsgList" OnDataBound="MsgList_DataBound" OnItemDataBound="MsgList_ItemDataBound" runat="server">
                                <ItemTemplate>
                                    <asp:Panel CssClass="post" ID="MsgDataPanel" runat="server">
        ...
        <div class="newmain">
            <div class="heading" style="margin-bottom: 20px;">
                <asp:Label ID="Label3" Font-Size="XX-Large" runat="server" Font-Bold="true"></asp:Label>
            </div>
            <script type="text/javascript">
                ...
                function scrollToBottom() {
                    if ($get('<%=Panel2.ClientID %>') != null) {
                        $get('<%= Panel2.ClientID %>').scrollTop = $get('<%= Panel2.ClientID %>').scrollHeight;
                    }
                }
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="Panel2" CssClass="msglist" runat="server">
                        <asp:ListView OnItemInserted="ListView1_ItemInserted" ID="ListView1" runat="server" OnItemDataBound="ListView1_ItemDataBound">
                            <ItemTemplate>
                                <div class="msglistitem">
                                    <asp:Panel ID="Panel1" runat="server">
                                        <table style="width: 100%;">
                                            <tr style="width: auto;" runat="server">
                ...
                <ContentTemplate>
                    <div class="newmsg">
                        <asp:Panel ID="PostPanel" runat="server">
                            <asp:TextBox ID="NewPost" runat="server" TextMode="MultiLine" CssClass="inputfield" Width="80%" placeholder="Your Message"></asp:TextBox>
                            <asp:Button ID="PostButton" runat="server" Text="Post" CssClass="button" Width="15%" OnClick="PostButton_Click" />
                        </asp:Panel>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
