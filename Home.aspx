...
<body>
    <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="NotPanel" CssClass="notpanel" Visible="false" runat="server">
                        ...
                        <div class="bottom">
                            <a href="Notifications.aspx">Show All Notifications</a>
                        </div>
                    </asp:Panel>
                    <asp:Panel ID="MsgPanel" CssClass="notmsgpanel" Visible="false" runat="server">
                        ...
                        <div class="bottom">
                            <a href="Messages.aspx">Show All</a>
                        </div>
                    </asp:Panel>
                    <asp:Panel ID="FrndPanel" CssClass="notfrndpanel" Visible="false" runat="server">
                        ...
                        <div class="bottom">
                            <a href="FriendRequests.aspx">Show All Requests</a>
                        </div>
                    </asp:Panel>
                </ContentTemplate>
                <Triggers>
        ...
        <div class="container">
            ...
            <asp:LinkButton CssClass="linkbutton" ID="LinkButton10" PostBackUrl="#" Text="News Feed" runat="server"></asp:LinkButton><hr />
        ...
        <div class="navbar">
            ...
            <asp:LinkButton CssClass="linkbutton" ID="LinkButton3" PostBackUrl="#" Text="News Feed" runat="server"></asp:LinkButton><hr />
            ...
            <ContentTemplate>
                <div class="newmain">
                    <div class="newpost">
                        ...
                        <asp:Button ID="PostButton" runat="server" Text="Post" CssClass="button left" OnClick="PostButton_Click" />
                    </div>
                    <div class="feed">
                        <asp:ListView ID="ListView1" runat="server" OnSelectedIndexChanged="ListView1_SelectedIndexChanged" OnItemDataBound="ListView1_ItemDataBound">
                            <ItemTemplate>
                                <table class="post">
                                    <tr runat="server" class="userdetails tabheader">
                                        <td colspan="2">
                                            <asp:Image ID="ProImage" runat="server" Width="30px" Height="30px" />
                                            <a href="Profiles.aspx?email=<%#Eval("Email") %>" class="link"><%#Eval("Name") %></a>
                                        </td>
                                        <td>
                                            <%#Eval("Date") %> &nbsp; &nbsp; <%#Eval("Time") %>
                                        </td>
